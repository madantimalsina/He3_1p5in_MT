...
void He3EventAction::EndOfEventAction(const G4Event* event)
{
  ...
  if ( fpositionHe3[0] > (-165.1 + (0.15*25.4))  && fpositionHe3[0] < (165.1 + (0.15*25.4)) &&
       std::sqrt( ((fpositionHe3[1] - 14.2875) * (fpositionHe3[1] - 14.2875)) + (((fpositionHe3[2] - (58.7375)) * (fpositionHe3[2] - (58.7375)) ))) <= 11.8872
     )
      {  if (fEnergyAbs > 0)  analysisManager->FillH1(7, fEnergyAbs); } 

  // Side Tube 1 (left) with cuts 
  if ( fpositionHe3[0] > (-165.1 + (0.15*25.4))  && fpositionHe3[0] < (165.1 + (0.15*25.4)) &&
       std::sqrt( ((fpositionHe3[1] + 112.71) * (fpositionHe3[1] + 112.71)) + ((fpositionHe3[2] - 58.7375) * (fpositionHe3[2] - 58.7375)) ) <= 11.8872
     )
     {  if (fEnergyAbs1 > 0) analysisManager->FillH1(8, fEnergyAbs1); }

  // Side Tube 2 (right) with cuts
  if ( fpositionHe3[0] > (-165.1 + (0.15*25.4))  && fpositionHe3[0] < (165.1 + (0.15*25.4)) &&
       std::sqrt( ((fpositionHe3[1] - 134.94) * (fpositionHe3[1] - 134.94)) + ((fpositionHe3[2] - 58.7375) * (fpositionHe3[2] - 58.7375)) ) <= 11.8872
     )
